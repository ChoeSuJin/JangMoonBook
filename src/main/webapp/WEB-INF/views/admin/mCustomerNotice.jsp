			...
			<c:forEach items="${ list }" var="list">
						<tr>
							<form action="deleteCustomerNotice.do" method="post">
								...
								<td><a data-toggle="modal" data-target="#notice${ list.articleNumber }">${ list.title }</a></td>
								<td>${ list.regDate }</td>
								<td><input type="submit" value="삭제"></td>
							</form>
							
							<div class="modal fade" id="notice${ list.articleNumber }" role="dialog">
									...
									<div class="modal-content">
										...
										<div class="modal-body">
											...
											<div class="form-group">
									             <label>글번호</label>
									             <input readonly="readonly" class="form-control" name="sent_id" value="${ list.articleNumber }">				  
									        </div>
											<div class="form-group">
									             <label>제목</label>
