    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12" >
          ...
          <div id="orgDistList" class="box" style="width : 45%; float: inherit;">
            <div class="box-header">
              <h3 class="box-title" id="orgName"></h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
            	<div id = "orgEbookList">
  ...
  function getOrgList(ono) {
		...
		$.ajax({
          ...
          success : function(data){
          	 ...
          	 oname = JSON.stringify(oname);
          	 var newOname = JSON.parse(oname);
          	 
          	 $("#orgName").val(newOname);
          	 
          	$("#orgEbookList").html("");
          	var html = '<table class="table table-bordered table-hover">'
          				+ '<thead><th>ISBN</th><th>제목</th></thead>';
          	if (newVal.length == 0) {
